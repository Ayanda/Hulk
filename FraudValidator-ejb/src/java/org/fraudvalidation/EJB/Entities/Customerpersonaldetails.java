...
public class Customerpersonaldetails implements Serializable {
    ...
    public Customerpersonaldetails(Integer iDNumber, String name, String surname, Date dateOfBirth, String contactNumber, String employeeStatus, String nationality, String race, Character gender, String postalAddress) {
        this.iDNumber = iDNumber;
        this.name = name;
    ...
    public String toString() {
        return "org.fraudvalidation.EJB.Entities.Customerpersonaldetails[ iDNumber=" + iDNumber + " ]";
    }
